...
// Comprehensive list of all 195 UN-recognized countries
...
window.worldCountries = worldCountries;

// Also load existing visited countries from conversation history
let visitedCountries = JSON.parse(localStorage.getItem('visitedCountries') || '[]');

// If localStorage is empty, check if there are any predefined visited countries
if (visitedCountries.length === 0) {
    // You can add default visited countries here based on the user's previous data
    visitedCountries = []; // Empty by default
}

window.visitedCountries = visitedCountries;
